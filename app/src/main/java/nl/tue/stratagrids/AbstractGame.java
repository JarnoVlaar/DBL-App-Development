 ...
 */
public abstract class AbstractGame extends ViewModel {
     ...
     */
    public AbstractGame(int[][] verticalLines, int[][] horizontalLines, int[][] capturedBlocks, int size, int currentPlayer, int players, int turnCount){
     ...
     * @param players representing the number of players in the game
     */
    public AbstractGame(int size, int players){
